...
- Upload Excel/CSV bank statements
...
This version is browser-only. Uploaded files are processed locally in the browser and saved to localStorage. There is no backend, database, login, or bank connection.
